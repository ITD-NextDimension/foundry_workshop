...
> Lab 4 用的 `fetch-traces.ps1`（调 Foundry tracing data plane API 拉本人 agent 的 trace）放在 `workshop/observability/local/` 下，与 HTML 在一起。
...
# Lab 2 persona lint
..\workshop-scripts\lint-persona.py personas\research-agent.md
